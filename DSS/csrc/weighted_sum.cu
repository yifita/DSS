...
// Modifications: use scalar_k and Q value map to get alpha
// Do this in python as done in points/renderer.py
// so the input is alphas, and no need to change things here
// Inputs:
...
__global__ void weightedSumCudaForwardKernel(
    ...
    // at::PackedTensorAccessor64<float, 4, at::RestrictPtrTraits> alphas,
    ...
    // const at::PackedTensorAccessor64<float, 1, at::RestrictPtrTraits> scalars,
    // const at::PackedTensorAccessor64<float, 4, at::RestrictPtrTraits> qvalue_map,
